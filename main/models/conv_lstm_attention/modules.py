...
class EncoderDecoderConvLSTM(nn.Module):
    def __init__(self, params, nf=8):
        ...
        self.encoder_1_convlstm = ConvLSTMBlock(
            in_chan, 4, kernel_size=(3, 3), bias=True, dropout=0.1
        )
        self.encoder_2_convlstm = ConvLSTMBlock(
            4, 8, kernel_size=(3, 3), bias=True, dropout=0.2
        )
        self.encoder_3_convlstm = ConvLSTMBlock(
            8, 16, kernel_size=(3, 3), bias=True, dropout=0.3
        )
        self.encoder_4_convlstm = ConvLSTMBlock(
            16, 32, kernel_size=(3, 3), bias=True, act=t.tanh, dropout=0.05, batch_norm=False
        )


        self.decoder_1_convlstm = ConvLSTMBlock(
            32, 32, kernel_size=(3, 3), bias=True, act=t.tanh, dropout=0.05, batch_norm=False
        )
        ...
        self.decoder_axial = AxialDecoder(params, 32)
