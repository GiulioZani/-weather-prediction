...
class EncoderDecoderConvLSTM(nn.Module):
    def __init__(self, params, nf=8):
        ...
        self.encoder_2_convlstm = ConvLSTMCell(
            input_dim=nf, hidden_dim=nf*2, kernel_size=(3, 3), bias=True
        )

        self.decoder_1_convlstm = ConvLSTMCell(
            input_dim=nf*2, hidden_dim=nf*4, kernel_size=(3, 3), bias=True  # nf + 1
        )

        self.decoder_2_convlstm = ConvLSTMCell(
            input_dim=nf*4, hidden_dim=nf*2, kernel_size=(3, 3), bias=True
        )
